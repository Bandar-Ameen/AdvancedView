...
import com.astooltech.advancedview.proteus.parser.webview.gm.agentweb.filechooser.agentwebcor.JsAccessEntrace;
import com.astooltech.advancedview.proteus.parser.webview.gm.agentweb.filechooser.agentwebcor.JsAccessEntraceImpl;
...
public class AdvancedWebView extends WebView  {
	...
	public interface Listener {
		...
		void openFileChosser(Intent intent, ValueCallback<Uri> fileUploadCallbackFirst, ValueCallback<Uri[]> fileUploadCallbackSecond);
	}
	...
	public LinearLayout getLinwting() {
		return Linwting;
	}
	...
	public void setLinwting(LinearLayout linwting) {
		Linwting = linwting;
	}

	private LinearLayout Linwting;

	public ProteusView getErrorView() {
		return ErrorView;
	}

	public void setErrorView(ProteusView errorView) {
		ErrorView = errorView;
	}

	private ProteusView ErrorView;
	...
	public void setListener(final Activity activity, final Listener listener, PermissionInterceptor r) {
		setListener(activity, listener, REQUEST_CODE_FILE_PICKER,r);
	}
    public JsAccessEntrace getJsAccessEntrace() {
        JsAccessEntrace mJsAccessEntrace = this.mJsAccessEntrace;
        if (mJsAccessEntrace == null) {
            this.mJsAccessEntrace = mJsAccessEntrace = JsAccessEntraceImpl.getInstance(this);
        }
	...
	public void setListener(final Activity activity, final Listener listener, final int requestCodeFilePicker, PermissionInterceptor da) {
		this.mPermissionInterceptor=da;
		if (activity != null) {
	...
	public void setListenerr(final Listener listener, final int requestCodeFilePicker) {
...
public void reloads(){
	...
	public void onActivityResultd(final int requestCode, final int resultCode, final Intent intent) {
...
*/
		...
		if (mListener != null) {
			mListener.openFileChosser(Intent.createChooser(i, getFileUploadPromptLabel()),fileUploadCallbackFirst,fileUploadCallbackSecond);
		}
	...
	public static boolean handleDownload(final Context context, final String fromUrl, final String toFilename) {
		...
		// if the download manager app has been disabled on the device
			...
			openAppSettings(context, com.astooltech.advancedview.proteus.parser.webview.gm.AdvancedWebView.PACKAGE_NAME_DOWNLOAD_MANAGER);

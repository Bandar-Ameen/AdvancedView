...
public class OverallAdapter extends FlexibleAdapter<AbstractFlexibleItem> {
    ...
    public OverallAdapter(Activity activity, List<AbstractFlexibleItem> items) {
        //true = Items implement hashCode() and have stableIds!
        super(items, activity, true);
    }
     ...
     */
    public void showLayoutInfo(boolean scrollToPosition) { if (!hasFilter()) {
            //Define Example View

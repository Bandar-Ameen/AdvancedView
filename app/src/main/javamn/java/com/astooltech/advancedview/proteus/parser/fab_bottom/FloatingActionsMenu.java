...
public class FloatingActionsMenu extends ViewGroup {
  ...
  public void setmAddButtonPlusColor(int mAddButtonPlusColor) {
    this.mAddButtonPlusColor = mAddButtonPlusColor;
  }

  public void setmAddButtonColorNormal(int mAddButtonColorNormal) {
    this.mAddButtonColorNormal = mAddButtonColorNormal;
  }

  public void setmAddButtonColorPressed(int mAddButtonColorPressed) {
    this.mAddButtonColorPressed = mAddButtonColorPressed;
  }

  public void setmAddButtonSize(int mAddButtonSize) {
    this.mAddButtonSize = mAddButtonSize;
  }

  public void setmAddButtonStrokeVisible(boolean mAddButtonStrokeVisible) {
    this.mAddButtonStrokeVisible = mAddButtonStrokeVisible;
  }
  ...
  public void setmButtonSpacing(int mButtonSpacing) {
    this.mButtonSpacing = mButtonSpacing;
  }

  public void setmLabelsMargin(int mLabelsMargin) {
    this.mLabelsMargin = mLabelsMargin;
  }
  ...
  public void setmLabelsPosition(int mLabelsPosition) {
    this.mLabelsPosition = mLabelsPosition;
  }
  ...
  protected void onLayout(boolean changed, int l, int t, int r, int b) {
    ...
    case EXPAND_DOWN:
      ...
      for (int i = mButtonsCount - 1; i >= 0; i--) {
        ...
        if (child instanceof protuseFloatinggActionButton) {

...
public final class Proteus {
  ...
  Proteus(@NonNull Map<String, Type> types, @NonNull final Map<String, Function> functions, @NonNull final Map<String, ALLEvent> even) {
    this.types = types;
    this.functions = new FunctionManager(functions);
    this.eventManger=new ALLEventManger(even);
  ...
  public ProteusContext.Builder createContextBuilder(@NonNull Context base) {
    return new ProteusContext.Builder(base, parsers, functions,eventManger);
  }

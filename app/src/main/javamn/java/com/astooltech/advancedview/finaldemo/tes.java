...
public class tes extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.astooltech.advancedview.R.layout.aa_activity_main_dd);
            ...
            public void updateContextTitle(int count) {
                if (mActionMode != null) {//You can use the internal ActionMode instance
                    mActionMode.setTitle(count == 1 ?
                            getString(com.astooltech.advancedview.R.string.action_selected_one, Integer.toString(count)) :
                            getString(com.astooltech.advancedview.R.string.action_selected_many, Integer.toString(count)));
                }
            }
...
public void initializeFragment(Bundle savedInstanceState) {
      ...
      try {
          ...
          fragmentManager.beginTransaction().replace(com.astooltech.advancedview.R.id.recycler_view_container,
                  mFragment).commit();
      }catch (Exception ex){
    ...
    private void initializeDrawer() {
        ...
        // Version
       // TextView appVersion = mNavigationView.getHeaderView(0).findViewById(com.astooltech.advancedview.R.id.app_version);
        //appVersion.setText(getString(com.astooltech.advancedview.R.string.about_version, Utils.getVersionName(this)));
    }

    private void initializeFab() {
        mFab = (FloatingActionButton) findViewById(com.astooltech.advancedview.R.id.fab);
...
try {
    ...
    if (id == com.astooltech.advancedview.R.id.nav_overall) {
        //mFragment = FragmentOverall.newInstance(2);
    } else if (id == com.astooltech.advancedview.R.id.nav_selection_modes) {
       // mFragment = FragmentSelectionModes.newInstance(2);
    } else if (id == com.astooltech.advancedview.R.id.nav_filter) {
        mFragment = FragmentAsyncFilter.newInstance(true);
    } else if (id == com.astooltech.advancedview.R.id.nav_animator) {
        mFragment = FragmentAnimators.newInstance();
    } else if (id == com.astooltech.advancedview.R.id.nav_endless_scrolling) {
        mFragment = FragmentEndlessScrolling.newInstance(2);
        showFab();
    } else if (id == com.astooltech.advancedview.R.id.nav_instagram_headers) {
        mFragment = FragmentInstagramHeaders.newInstance();
    } else if (id == com.astooltech.advancedview.R.id.nav_db_headers_and_sections) {

    } else if (id == com.astooltech.advancedview.R.id.nav_headers_and_sections) {
        mFragment = FragmentHeadersSections.newInstance(2);
        showFab();
    } else if (id == com.astooltech.advancedview.R.id.nav_multi_level_expandable) {
        mFragment = FragmentExpandableMultiLevel.newInstance(2);
    } else if (id == com.astooltech.advancedview.R.id.nav_expandable_sections) {
        mFragment = FragmentExpandableSections.newInstance(3);
        showFab();
    } else if (id == com.astooltech.advancedview.R.id.nav_staggered) {
        mFragment = FragmentStaggeredLayout.newInstance(2);
    } else if (id == com.astooltech.advancedview.R.id.nav_model_holders) {
        mFragment = FragmentHolderSections.newInstance();
    } else if (id == com.astooltech.advancedview.R.id.nav_viewpager) {
        ...
        return true;
    } else if (id == com.astooltech.advancedview.R.id.nav_about) {
        MessageDialog.newInstance(
                com.astooltech.advancedview.R.drawable.ic_info_grey600_24dp,
                getString(com.astooltech.advancedview.R.string.about_title),
                getString(com.astooltech.advancedview.R.string.about_body, Utils.getVersionName(this)))
                .show(getFragmentManager(), MessageDialog.TAG);
        return true;
    } else if (id == com.astooltech.advancedview.R.id.nav_github) {
        Intent intent = new Intent(Intent.ACTION_VIEW);
        intent.setData(Uri.parse("https://github.com/davideas/FlexibleAdapter"));
        startActivity(Intent.createChooser(intent, getString(com.astooltech.advancedview.R.string.intent_chooser)));
        return true;
    }
    ...
    if (mFragment != null) {
        ...
        FragmentManager fragmentManager = getSupportFragmentManager();
        fragmentManager.beginTransaction().replace(com.astooltech.advancedview.R.id.recycler_view_container, mFragment).commit();
        // Close drawer
        mRecyclerView.post(new Runnable() {
            @Override
            public void run() {
        ...
        mHeaderView.bindTo(getString(com.astooltech.advancedview.R.string.app_name), item.getTitle());
...
return false;
    ...
    public void initSearchView(final Menu menu) {
        ...
        MenuItem searchItem = menu.findItem(com.astooltech.advancedview.R.id.action_search);
        if (searchItem != null) {
            MenuItemCompat.setOnActionExpandListener(
                    searchItem, new MenuItemCompat.OnActionExpandListener() {
                        @Override
                        public boolean onMenuItemActionExpand(MenuItem item) {
                            MenuItem listTypeItem = menu.findItem(com.astooltech.advancedview.R.id.action_list_type);
            ...
            mSearchView.setQueryHint(getString(com.astooltech.advancedview.R.string.action_search));
    ...
    public boolean onPrepareOptionsMenu(Menu menu) {
        ...
        if (mSearchView != null) {
            ...
            if (!mAdapter.hasFilter()) {
                ...
                menu.findItem(com.astooltech.advancedview.R.id.action_search).expandActionView();//must be called first
        ...
        // Fast Scroller
        MenuItem fastScrollerItem = menu.findItem(com.astooltech.advancedview.R.id.action_fast_scroller);
        if (fastScrollerItem != null) {
            fastScrollerItem.setChecked(mAdapter.isFastScrollerEnabled());
        }
        // Animate on update?
        MenuItem animateUpdateMenuItem = menu.findItem(com.astooltech.advancedview.R.id.action_animate_on_update);
        if (animateUpdateMenuItem != null) {
            animateUpdateMenuItem.setChecked(DatabaseConfiguration.animateOnUpdate);
        }
        // Headers are shown?
        MenuItem headersMenuItem = menu.findItem(com.astooltech.advancedview.R.id.action_show_hide_headers);
        if (headersMenuItem != null) {
            headersMenuItem.setTitle(mAdapter.areHeadersShown() ? com.astooltech.advancedview.R.string.hide_headers : com.astooltech.advancedview.R.string.show_headers);
        }
        // Sticky Header item?
        MenuItem stickyItem = menu.findItem(com.astooltech.advancedview.R.id.action_sticky_headers);
        if (stickyItem != null) {
            stickyItem.setEnabled(mAdapter.areHeadersShown());
            stickyItem.setChecked(mAdapter.areHeadersSticky());
        }
        // Scrolling Animations?
        MenuItem animationMenuItem = menu.findItem(com.astooltech.advancedview.R.id.action_forward);
        ...
        MenuItem reverseMenuItem = menu.findItem(com.astooltech.advancedview.R.id.action_reverse);
        if (reverseMenuItem != null) {
            reverseMenuItem.setChecked(mAdapter.isAnimationOnReverseScrollingEnabled());
        }
        //DiffUtil?
        MenuItem diffUtilItem = menu.findItem(com.astooltech.advancedview.R.id.action_diff_util);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        int id = item.getItemId();
        if (id == com.astooltech.advancedview.R.id.action_animate_on_update) {
            ...
            Snackbar.make(findViewById(com.astooltech.advancedview.R.id.main_view), (DatabaseConfiguration.animateOnUpdate ? "Enabled" : "Disabled") +
                    " animation on update, now refresh!\n(* = persistent)", Snackbar.LENGTH_SHORT).show();
        } else if (id == com.astooltech.advancedview.R.id.action_forward) {
            if (mAdapter.isAnimationOnForwardScrollingEnabled()) {
                ...
                Snackbar.make(findViewById(com.astooltech.advancedview.R.id.main_view), "Disabled forward scrolling animation\n(* = persistent)", Snackbar.LENGTH_SHORT).show();
            } else {
                DatabaseConfiguration.animateOnForwardScrolling = true;
                mAdapter.setAnimationOnForwardScrolling(true);
                item.setChecked(true);
                Snackbar.make(findViewById(com.astooltech.advancedview.R.id.main_view), "Enabled forward scrolling animation\n(* = persistent)", Snackbar.LENGTH_SHORT).show();
            }
        } else if (id == com.astooltech.advancedview.R.id.action_reverse) {
            if (mAdapter.isAnimationOnReverseScrollingEnabled()) {
                mAdapter.setAnimationOnReverseScrolling(false);
                item.setChecked(false);
                Snackbar.make(findViewById(com.astooltech.advancedview.R.id.main_view), "Disabled reverse scrolling animation", Snackbar.LENGTH_SHORT).show();
            } else {
                mAdapter.setAnimationOnReverseScrolling(true);
                item.setChecked(true);
                Snackbar.make(findViewById(com.astooltech.advancedview.R.id.main_view), "Enabled reverse scrolling animation", Snackbar.LENGTH_SHORT).show();
            }
        } else if (id == com.astooltech.advancedview.R.id.action_diff_util) {
            if (mAdapter.isAnimateChangesWithDiffUtil()) {
                ...
                item.setChecked(false);
                Snackbar.make(findViewById(com.astooltech.advancedview.R.id.main_view), "Default calculation is used to animate changes\n(* = persistent)", Snackbar.LENGTH_SHORT).show();
            } else {
                DatabaseConfiguration.animateWithDiffUtil = true;
                mAdapter.setAnimateChangesWithDiffUtil(true);
                item.setChecked(true);
                Snackbar.make(findViewById(com.astooltech.advancedview.R.id.main_view), "DiffUtil is used to animate changes\n(* = persistent)", Snackbar.LENGTH_SHORT).show();
            }
        } else if (id == com.astooltech.advancedview.R.id.action_auto_collapse) {
            if (mAdapter.isAutoCollapseOnExpand()) {
                mAdapter.setAutoCollapseOnExpand(false);
                item.setChecked(false);
                Snackbar.make(findViewById(com.astooltech.advancedview.R.id.main_view), "Auto-Collapse is disabled", Snackbar.LENGTH_SHORT).show();
            } else {
                mAdapter.setAutoCollapseOnExpand(true);
                item.setChecked(true);
                Snackbar.make(findViewById(com.astooltech.advancedview.R.id.main_view), "Auto-Collapse is enabled", Snackbar.LENGTH_SHORT).show();
            }
        } else if (id == com.astooltech.advancedview.R.id.action_expand_collapse_all) {
            if (item.getTitle().equals(getString(com.astooltech.advancedview.R.string.expand_all))) {
                int total = mAdapter.expandAll();
                Toast.makeText(this, "Expanded " + total + " items", Toast.LENGTH_SHORT).show();
                item.setTitle(com.astooltech.advancedview.R.string.collapse_all);
            } else {
                int total = mAdapter.collapseAll();
                Toast.makeText(this, "Collapsed " + total + " items", Toast.LENGTH_SHORT).show();
                item.setTitle(com.astooltech.advancedview.R.string.expand_all);
            }
        } else if (id == com.astooltech.advancedview.R.id.action_show_hide_headers) {
            if (mAdapter.areHeadersShown()) {
                mAdapter.hideAllHeaders();
                item.setTitle(com.astooltech.advancedview.R.string.show_headers);
            } else {
                mAdapter.showAllHeaders();
                item.setTitle(com.astooltech.advancedview.R.string.hide_headers);
            }
        } else if (id == com.astooltech.advancedview.R.id.action_sticky_headers) {
            mAdapter.setStickyHeaders(!mAdapter.areHeadersSticky());
            item.setChecked(!mAdapter.areHeadersSticky());
            Snackbar.make(findViewById(com.astooltech.advancedview.R.id.main_view), "Sticky headers " +
                    (mAdapter.areHeadersSticky() ? "disabled" : "enabled"), Snackbar.LENGTH_SHORT).show();
        } else if (id == com.astooltech.advancedview.R.id.action_selection_mode) {
            if (mAdapter.getMode() == Mode.IDLE) {
                mAdapter.setMode(Mode.SINGLE);
                mActionModeHelper.withDefaultMode(Mode.SINGLE);
                item.setIcon(com.astooltech.advancedview.R.drawable.ic_select_off_white_24dp);
                item.setTitle(com.astooltech.advancedview.R.string.mode_idle);
                Snackbar.make(findViewById(com.astooltech.advancedview.R.id.main_view), "Selection SINGLE is enabled", Snackbar.LENGTH_SHORT).show();
            } else {
                mAdapter.setMode(Mode.IDLE);
                mActionModeHelper.withDefaultMode(Mode.IDLE);
                item.setIcon(com.astooltech.advancedview.R.drawable.ic_select_white_24dp);
                item.setTitle(com.astooltech.advancedview.R.string.mode_single);
                Snackbar.make(findViewById(com.astooltech.advancedview.R.id.main_view), "Selection IDLE is enabled", Snackbar.LENGTH_SHORT).show();
            }
        } else if (id == com.astooltech.advancedview.R.id.action_fast_scroller) {
            mAdapter.toggleFastScroller();
            item.setChecked(mAdapter.isFastScrollerEnabled());
        } else if (id == com.astooltech.advancedview.R.id.action_reset || id == com.astooltech.advancedview.R.id.action_delete) {
            showFab();
        }
...
//		}
    ...
    public void onItemSwipe(final int position, int direction) {
        ...
        if (direction == ItemTouchHelper.LEFT) {
            message.append(getString(com.astooltech.advancedview.R.string.action_archived));

            // Example of UNDO color
            int actionTextColor;
            if (Utils.hasMarshmallow()) {
                actionTextColor = getColor(com.astooltech.advancedview.R.color.material_color_orange_500);
            } else {
                //noinspection deprecation
                actionTextColor = getResources().getColor(com.astooltech.advancedview.R.color.material_color_orange_500);
            }
            ...
            new UndoHelper(mAdapter, this)
                    ...
                    .start(positions, findViewById(com.astooltech.advancedview.R.id.main_view), com.astooltech.advancedview.R.string.action_archived,
                            com.astooltech.advancedview.R.string.undo, UndoHelper.UNDO_TIMEOUT);

            // Here, option 2) is implemented
        } else if (direction == ItemTouchHelper.RIGHT) {
            // Prepare for next deletion
            message.append(getString(com.astooltech.advancedview.R.string.action_deleted));
            mRefreshHandler.sendEmptyMessage(REFRESH_START);
            mAdapter.setPermanentDelete(false);
            ...
            new UndoHelper(mAdapter, this)
                    ...
                    .start(positions, findViewById(com.astooltech.advancedview.R.id.main_view), message,
                            getString(com.astooltech.advancedview.R.string.undo), UndoHelper.UNDO_TIMEOUT);
    ...
    public void onUpdateEmptyDataView(int size) {
        if (mAdapter != null && !mAdapter.isRestoreInTime() &&
            ...
            Snackbar.make(findViewById(com.astooltech.advancedview.R.id.main_view), message, Snackbar.LENGTH_SHORT).show();
        }
    }
...
//            }
    ...
    public void onActionConfirmed(@UndoHelper.Action int action, int event) {
        ...
        for (AbstractFlexibleItem adapterItem : mAdapter.getDeletedItems()) {
            ...
            if (layoutRes == com.astooltech.advancedview.R.layout.recycler_sub_item) {
            ...
            } else if (layoutRes == com.astooltech.advancedview.R.layout.recycler_simple_item || layoutRes == com.astooltech.advancedview.R.layout.recycler_expandable_item) {
    ...
    public boolean onCreateActionMode(ActionMode mode, Menu menu) {
        if (Utils.hasMarshmallow()) {
            getWindow().setStatusBarColor(getResources().getColor(com.astooltech.advancedview.R.color.colorAccentDark_light, this.getTheme()));
        } else if (Utils.hasLollipop()) {
            //noinspection deprecation
            getWindow().setStatusBarColor(getResources().getColor(com.astooltech.advancedview.R.color.colorAccentDark_light));
        }
        return true;
    }
    ...
    public boolean onActionItemClicked(ActionMode mode, MenuItem item) {
     ...
     Toast.makeText(this,"ffffff",Toast.LENGTH_LONG).show();
        ...
        if (itemId == com.astooltech.advancedview.R.id.action_select_all) {
            mAdapter.selectAll();
            mActionModeHelper.updateContextTitle(mAdapter.getSelectedItemCount());
            // We consume the event
            return true;
        } else if (itemId == com.astooltech.advancedview.R.id.action_delete) {// Build message before delete, for the SnackBar
            StringBuilder message = new StringBuilder();
            message.append(getString(com.astooltech.advancedview.R.string.action_deleted)).append(" ");
            ...
            new UndoHelper(mAdapter, this)
                    ...
                    .start(mAdapter.getSelectedPositions(),
                            findViewById(com.astooltech.advancedview.R.id.main_view), message,
                            getString(com.astooltech.advancedview.R.string.undo), UndoHelper.UNDO_TIMEOUT);
            ...
            // We consume the event
            return true;
        } else if (itemId == com.astooltech.advancedview.R.id.action_merge) {
            if (mAdapter.getSelectedItemCount() > 1) {
            ...
            return true;
        } else if (itemId == com.astooltech.advancedview.R.id.action_split) {
            if (mAdapter.getSelectedItemCount() == 1) {
    ...
    public void onDestroyActionMode(ActionMode mode) {
        if (Utils.hasMarshmallow()) {
            getWindow().setStatusBarColor(getResources().getColor(com.astooltech.advancedview.R.color.colorPrimaryDark_light, this.getTheme()));
        } else if (Utils.hasLollipop()) {
            //noinspection deprecation
            getWindow().setStatusBarColor(getResources().getColor(com.astooltech.advancedview.R.color.colorPrimaryDark_light));
        }
    }
    ...
    public void onBackPressed() {
        ...
        if (DatabaseService.getInstance().getDatabaseType() != DatabaseType.OVERALL) {
            MenuItem menuItem = mNavigationView.getMenu().findItem(com.astooltech.advancedview.R.id.nav_overall);
            onNavigationItemSelected(menuItem);
            return;
        }
        // Close the App

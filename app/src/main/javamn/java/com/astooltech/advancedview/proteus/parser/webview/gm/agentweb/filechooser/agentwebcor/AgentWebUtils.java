...
import static com.astooltech.advancedview.proteus.parser.webview.gm.agentweb.filechooser.agentwebcor.AgentWebConfig.AGENTWEB_FILE_PATH;
import static com.astooltech.advancedview.proteus.parser.webview.gm.agentweb.filechooser.agentwebcor.AgentWebConfig.FILE_CACHE_PATH;
...
public class AgentWebUtils {
	...
	static Uri getUriFromFileForN(Context context, File file) {
		Uri fileUri = FileProvider.getUriForFile(context, context.getPackageName() + ".dynimicall.proteus.parser.webview.gm.agentweb.filechooser.agentwebcor.AgentWebFileProvider", file);
		return fileUri;
	}
...
//	com.astooltech.advancedview.proteus.parser.webview.gm.agentweb.filechooser.agentwebcor.AgentWebFileProvider.
...
//		LogUtils.i(TAG, "getAuthority:" + fileUri.getAuthority() + "  getHost:" + fileUri.getHost() + "   getPath:" + fileUri.getPath() + "  getScheme:" + fileUri.getScheme() + "  query:" + fileUri.getQuery());
		if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT && DocumentsContract.isDocumentUri(context, fileUri)) {
			...
			//com.astooltech.advancedview.
			//com.astooltech.advancedview.proteus.parser.webview.gm.agentweb.filechooser.download.library.
		} // MediaStore (and general)
		else if (fileUri.getAuthority().equalsIgnoreCase(context.getPackageName() + ".dynimicall.proteus.parser.webview.gm.agentweb.filechooser.agentwebcor.AgentWebFileProvider")) {

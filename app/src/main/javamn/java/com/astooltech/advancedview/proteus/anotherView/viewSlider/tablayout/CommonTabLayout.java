package com.astooltech.advancedview.proteus.anotherView.viewSlider.tablayout;
...
import com.astooltech.advancedview.proteus.anotherView.viewSlider.tablayout.utils.FragmentChangeManager;
...
try {
    ...
    public void setTabData(ArrayList<CustomTabEntity> titles, FragmentManager fa, int containerViewId, ArrayList<Fragment> fragments) {
    ...
    private void addTab(final int position, View tabView) {
      ...
      if(mTabEntitys.get(position).typSelect()==0) {
          iv_tab_icon.setImageResource(mTabEntitys.get(position).getTabUnselectedIcon());
      }else {
          iv_tab_icon.setImageDrawable(mTabEntitys.get(position).getTabUnselectedIconA());
...
//            tv_tab_title.setPadding((int) mTabPadding, 0, (int) mTabPadding, 0);
            ...
            if (mIconVisible) {
                ...
                if(tabEntity.typSelect()==0) {
                    iv_tab_icon.setImageResource(i == mCurrentTab ? tabEntity.getTabSelectedIcon() : tabEntity.getTabUnselectedIcon());

                }else {

                    iv_tab_icon.setImageDrawable(i == mCurrentTab ? tabEntity.getTabSelectedIconA() : tabEntity.getTabUnselectedIconA());
    ...
    private void updateTabSelection(int position) {
        for (int i = 0; i < mTabCount; ++i) {
            ...
            if(tabEntity.typSelect()==0) {
                ...
                iv_tab_icon.setImageDrawable(isSelect ? tabEntity.getTabSelectedIconA() : tabEntity.getTabUnselectedIconA());

    ...
    protected void addAttributeProcessors() {
        ...
        addAttributeProcessor("mdata", new AttributeProcessor<V>() {
            ...
            public void handleValue(final V view, final Value value) {
                ...
                String Typanm="WORM";
                try {
                    time3 =Integer.valueOf(value.getAsObject().getAsString("time"));
                    typanmation =Integer.valueOf(value.getAsObject().getAsString("Typedir"));
                    Typanm =value.getAsObject().getAsString("anmationType");
                    autosecyl =Boolean.valueOf(value.getAsObject().getAsString("runAuto"));
                }catch (Exception ex){


                }
                //  view.setIndicatorAnimation(IndicatorAnimationType.valueOf(Typanm)); //set indicator animation by using SliderLayout.IndicatorAnimations. :WORM or THIN_WORM or COLOR or DROP or FILL or NONE or SCALE or SCALE_DOWN or SLIDE and SWAP!!
                ...
                // ==0?
                // :(typanmation==1?//:
                //   typanmation==2?view.setAutoCycleDirection(SliderView.AUTO_CYCLE_DIRECTION_RIGHT):view.setAutoCycleDirection(SliderView.AUTO_CYCLE_DIRECTION_LEFT)
...
if(!colora.equals("0")){
    ...
    view.setIndicatorSelectedColor(Color.WHITE);
                    ...
                    // String anmationduration = value.getAsObject().getAsString(Attributes.SliderbareView.sliderAnimationDuration);
                   /* view.setSliderAnimationDuration(500);
                    view.setAutoCycleDirection(SliderView.AUTO_CYCLE_DIRECTION_BACK_AND_FORTH);
                    view.setIndicatorSelectedColor(R.color.green);
               //  view.setSelectedColor(R.color.red_50);
                  //  SliderViewAdapter
                   view.setAutoCycle(true);
                   view.setScrollTimeInMillis(4);*/
                   // view.setLayoutManager(layoutManager);
                   //view.setSliderAdapter();
                   /* String anmationduration = value.getAsObject().getAsString(Attributes.SliderbareView.sliderAutoCycleDirection);



                    boolean indicatorEnabled = view.getBoolean(R.styleable.SliderView_sliderIndicatorEnabled, true);
                    ...
                    int sliderAutoCycleDirection = ParseHelper.parseInt(R.styleable.SliderView_sliderAutoCycleDirection);

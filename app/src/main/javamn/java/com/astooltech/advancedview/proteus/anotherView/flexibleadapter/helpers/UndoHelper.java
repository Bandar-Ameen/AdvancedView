...
public class UndoHelper extends Snackbar.Callback implements FlexibleAdapter.OnDeleteCompleteListener {
    ...
    /**
     * By default {@link Action#REMOVE} is performed.
     *
     * @param action the action, one of {@link Action#REMOVE}, {@link Action#UPDATE}
     * @return this object, so it can be chained
     */
    ...
    public interface OnActionListener {
         ...
         *
         * @param action one of {@link Action#REMOVE}, {@link Action#UPDATE}

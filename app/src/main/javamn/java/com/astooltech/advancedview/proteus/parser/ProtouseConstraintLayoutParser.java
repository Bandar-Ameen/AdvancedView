...
package com.astooltech.advancedview.proteus.parser;
        ...
        import com.astooltech.advancedview.proteus.view.ProtouseConstraintLayout;
 ...
 */
public class ProtouseConstraintLayoutParser<T extends ConstraintLayout> extends ViewTypeParser<T> {
    ...
    public ProteusView createView(@NonNull ProteusContext context, @NonNull Layout layout, @NonNull ObjectValue data,
        ...
        return new ProtouseConstraintLayout(context);
    }
    ...
    public void GetAndSetData(ProteusView view, DataValueSelect data, int typoper, Object anotherdat, String viewname) {
        ...
        if(view instanceof ProtouseConstraintLayout){
            prograssbarr((ProtouseConstraintLayout)view,data,typoper);
        }
    }
    ...
    private void getwithanotheroper(ProtouseConstraintLayout dt, DataValueSelect datb, int typoper){
        ProtouseConstraintLayout ccc=dt;
        if (typoper == 2) {
    ...
    private  void prograssbarr(ProtouseConstraintLayout dt,DataValueSelect datb,int ty ){

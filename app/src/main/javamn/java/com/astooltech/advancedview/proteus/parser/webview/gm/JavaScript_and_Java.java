...
import com.astooltech.advancedview.proteus.parser.custom.dataBase64JavaSModel;
...
import com.astooltech.advancedview.proteus.parser.webview.gm.avoid.AvoidOnResultHelper;
...
//                LogUtils.i(TAG, Arrays.toString(clz.getDeclaredMethods()));
    ...
    public void showHeadsUpNotification(String te) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            builder = new NotificationCompat.Builder(conn, notificationChannel.getId()).setSmallIcon(R.drawable.camera_icon);
    ...
    public void showRemoteInputNotification(String te) {
        ...
        NotificationCompat.Builder notification = NotificationHelper.createNotificationBuider(conn,
                "Remote Input", te, R.drawable.ic_notifications);
        ...
        notification.setColor(ContextCompat.getColor(conn, R.color.colorAccent));
    ...
    public void showSummaryNotification(String te) {
        ...
        NotificationCompat.Builder summary_notification = NotificationHelper.createNotificationBuider(conn,
                "2 new messages", te, R.drawable.ic_notifications, pIntent);

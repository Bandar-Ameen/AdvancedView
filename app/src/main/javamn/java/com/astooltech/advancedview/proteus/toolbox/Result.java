...
public class Result {
   ...
   * property inside a {@link com.astooltech.advancedview.proteus.value.Primitive} or {@link com.astooltech.advancedview.proteus.value.Array}.
   */
  public static final int RESULT_INVALID_DATA_PATH_EXCEPTION = -2;

  /**
   * Indicates that the data path prematurely led to a {@link com.astooltech.advancedview.proteus.value.Null}
   */
   ...
   * a valid {@link com.astooltech.advancedview.proteus.value.Value}.
   */

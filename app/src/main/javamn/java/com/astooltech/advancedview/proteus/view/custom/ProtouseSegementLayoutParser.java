...
import com.astooltech.advancedview.proteus.anotherView.viewSlider.tablayout.SegmentTabLayout;
...
public class ProtouseSegementLayoutParser<T extends SegmentTabLayout> extends ViewTypeParser<T> {
    ...
    public ProteusView createView(@NonNull ProteusContext context, @NonNull Layout layout, @NonNull ObjectValue data,
        ...
        return new ProtouseSegementLayout(context);
    }
    ...
    public void GetAndSetData(ProteusView view, DataValueSelect data, int typoper, Object anotherdat, String viewname) {
        ...
        if(typoper==105){
            try {
                if(view instanceof ProtouseSegementLayout) {
                    ProtouseSegementLayout k=(ProtouseSegementLayout)view;
        ...
        if(view instanceof  ProtouseSegementLayout) {
            ProtouseSegementLayout wwq = (ProtouseSegementLayout) view;
    ...
    protected void addAttributeProcessors() {
        addAttributeProcessor("Common_data", new AttributeProcessor<T>() {
            ...
            public void handleValue(T view, Value value) {
                ...
                try {
                   // boolean colunnvv = value.getAsObject().get("Common_ShowIcon").getAsBoolean();

                    //view.icon.setIconVisible(colunnvv);
                }catch (Exception ex){
            ...
            final String[] mTitles_3 = {"首页", "消息", "联系人", "更多"};
                ProteusView.Manager.ActionEventView Act = new ProteusView.Manager.ActionEventView() {
                    ...
                    public void getFragment(ProteusView vm, int typ, String anotherdata, FragmentManager mfrag) {
                        ProtouseSegementLayout dd=(ProtouseSegementLayout) view;
...
*/
                ...
                if (((ProtouseSegementLayout) view).getViewManager().getActionEventView() == null) {
                    ((ProtouseSegementLayout) view).getViewManager().setActionEventView(Act);

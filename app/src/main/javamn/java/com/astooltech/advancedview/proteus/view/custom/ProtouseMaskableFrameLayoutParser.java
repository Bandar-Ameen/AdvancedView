...
public class ProtouseMaskableFrameLayoutParser<T extends MaskableFrameLayout> extends ViewTypeParser<T> {
    ...
    public ProteusView createView(@NonNull ProteusContext context, @NonNull Layout layout, @NonNull ObjectValue data,
        ...
        return new ProtouseMaskableFrameLayout(context);
    }
    ...
    protected void addAttributeProcessors() {
        ...
        addAttributeProcessor(Attributes.View.masklayout, new DrawableResourceProcessor<T>() {
            @Override
            public void setDrawable(T view, Drawable drawable) {
               view.setMask(drawable);
                view.setPorterDuffXferMode(PorterDuff.Mode.SCREEN);
               // view.
            }
        });

        addAttributeProcessor(Attributes.View.masklayouttype, new StringAttributeProcessor<T>() {
            @Override

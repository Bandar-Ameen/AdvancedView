...
private Context context;
    ...
    public static QiscusComment generateMessage(long roomId, String content) {
        QiscusAccount qiscusAccount = mcor.getQiscusAccount();
    ...
    public boolean isMyComment() {
        return false; //getSenderEmail().equals(QiscusCore.getQiscusAccount().getEmail());
    }
    ...
    public String getExtension() {
        ...
        return null;//QiscusFileUtil.getExtension(getAttachmentName());
    }
        ...
        ((Activity)context).runOnUiThread(new Runnable() {
            ...
            public void run() {
                if (downloadingListener != null) {
                    downloadingListener.onDownloading(QiscusComment.this, downloading);
                }
            }
        });
    }
        ...
        ((Activity)context).runOnUiThread(new Runnable() {
            ...
            public void run() {
                if (progressListener != null) {
                    progressListener.onProgress(QiscusComment.this, progress);
                }
    ...
    public interface LinkPreviewListener {
        void onLinkPreviewReady(QiscusComment qiscusComment);
    }

...
public abstract class SliderViewAdapter<VH extends SliderViewAdapter.ViewHolder> extends PagerAdapter {
    ...
    public Object instantiateItem(@NonNull ViewGroup container, int position) {
        ...
        if (viewHolder == null) {
            viewHolder = onCreateViewHolder(container,position,getItemViewType(position));
        }
    ...
    public abstract VH onCreateViewHolder(ViewGroup parent,int position,int viewType);

...
public class PasswordEditText extends AppCompatEditText {
    ...
    public Drawable getmShowPwDrawable() {
        return mShowPwDrawable;
    }

    public void setmShowPwDrawable(Drawable mShowPwDrawable) {
        this.mShowPwDrawable = mShowPwDrawable;
        invalidate();
    }

    public Drawable getmHidePwDrawable() {
        return mHidePwDrawable;
    }

    public void setmHidePwDrawable(Drawable mHidePwDrawable) {
        this.mHidePwDrawable = mHidePwDrawable;
        invalidate();
    }

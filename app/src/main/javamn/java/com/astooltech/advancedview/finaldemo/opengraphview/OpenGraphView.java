...
import com.astooltech.advancedview.finaldemo.opengraphview.network.DefaultTaskManager;
import com.astooltech.advancedview.finaldemo.opengraphview.network.model.OGData;
import com.astooltech.advancedview.finaldemo.opengraphview.network.tasks.BaseTask;
import com.astooltech.advancedview.finaldemo.opengraphview.network.tasks.FaviconCallable;
import com.astooltech.advancedview.finaldemo.opengraphview.network.tasks.FaviconTask;
import com.astooltech.advancedview.finaldemo.opengraphview.network.tasks.ImageCallable;
import com.astooltech.advancedview.finaldemo.opengraphview.network.tasks.ImageTask;
import com.astooltech.advancedview.finaldemo.opengraphview.network.tasks.OGDataCallable;
import com.astooltech.advancedview.finaldemo.opengraphview.network.tasks.OGDataTask;
...
public class OpenGraphView extends RelativeLayout {
   ...
   //     setBgColor(array.getColor(R.styleable.OpenGraphView_bgColor,
    ...
    private void setStrokeWidth() {
        ...
        LayoutParams param = (LayoutParams) mSeparator.getLayoutParams();
    ...
    private void setContentParam(int rule) {
        LayoutParams contentsParams = new LayoutParams(

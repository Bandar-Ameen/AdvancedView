...
import com.astooltech.advancedview.proteus.anotherView.flexibleadapter.items.AbstractExpandableHeaderItem;
...
public class AnimatorExpandableItem
        extends AbstractExpandableHeaderItem<AnimatorExpandableItem.AnimatorExpandableViewHolder, AnimatorSubItem> {
    ...
    @Override
    public AnimatorExpandableViewHolder createViewHolder(View view, FlexibleAdapter adapter,int viewType) {

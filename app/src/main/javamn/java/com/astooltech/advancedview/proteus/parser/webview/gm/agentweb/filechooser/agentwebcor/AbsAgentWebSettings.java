...
public abstract class AbsAgentWebSettings implements IAgentWebSettings, WebListenerManager {
    ...
    @Override
    public IAgentWebSettings Fromvalue(Value webViewv) {
        settingsv(webViewv);
        return this;
    }
    ...
    private void settingsv(Value value) {
     //   mWebSettings = webView.getSettings();
      ...
      //  mWebSettings.setAppCachePath(dir);
        ...
        mWebSettings.setLoadsImagesAutomatically(value.getAsObject().getAsBoolean("image_auto"));
        mWebSettings.setJavaScriptEnabled(value.getAsObject().getAsBoolean("enab_java"));
        mWebSettings.setUseWideViewPort(value.getAsObject().getAsBoolean("enab_port"));
    //mAgentWeb.getWebCreator().getWebView().setDesktopMode(value.getAsObject().getAsBoolean("enab_desktop"));
        mWebSettings.setSupportMultipleWindows(value.getAsObject().getAsBoolean("enab_multiplwindow"));//.setLoadWithOverviewMode(true);
        mWebSettings.setLoadWithOverviewMode(value.getAsObject().getAsBoolean("enab_OverViewMode"));
        mWebSettings.setJavaScriptCanOpenWindowsAutomatically(value.getAsObject().getAsBoolean("enab_Open_window_Auto"));//.setJavaScriptEnabled(true);
     //   mAgentWeb.getWebCreator().getWebView().setCookiesEnabled(value.getAsObject().getAsBoolean("enab_cookies"));

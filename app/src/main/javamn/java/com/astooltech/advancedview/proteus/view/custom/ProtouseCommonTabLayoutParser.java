...
public class ProtouseCommonTabLayoutParser<T extends CommonTabLayout> extends ViewTypeParser<T> {
    ...
    public ProteusView createView(@NonNull ProteusContext context, @NonNull Layout layout, @NonNull ObjectValue data,
        ...
        return new ProtouseCommonTabLayout(context);
    }
    ...
    public void GetAndSetData(ProteusView view, DataValueSelect data, int typoper, Object anotherdat, String viewname) {
        ...
        if(typoper==105){
            try {
                if(view instanceof ProtouseCommonTabLayout) {
                    ProtouseCommonTabLayout k=(ProtouseCommonTabLayout)view;
            ...
            if (view instanceof ProtouseCommonTabLayout) {
                ProtouseCommonTabLayout wwq = (ProtouseCommonTabLayout) view;

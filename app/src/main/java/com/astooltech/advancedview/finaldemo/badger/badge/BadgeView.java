...
package com.astooltech.advancedview.finaldemo.badger.badge;
...
public class BadgeView extends View implements Badge {
    ...
    private void init() {
        ...
        mBadgeTextSize = rr.sp2px(getContext(), DEFAULT_TEXT_SIZE);
    ...
    public float getBadgeTextSize(boolean isSpValue) {
        return isSpValue ? rr.px2dp(getContext(), mBadgeTextSize) : mBadgeTextSize;
    }
    ...
    public float getBadgePadding(boolean isDpValue) {
        return isDpValue ? rr.px2dp(getContext(), mBadgePadding) : mBadgePadding;
    }
    ...
    public float getGravityOffsetX(boolean isDpValue) {
        return isDpValue ? rr.px2dp(getContext(), mGravityOffsetX) : mGravityOffsetX;
    }

    @Override
    public float getGravityOffsetY(boolean isDpValue) {
        return isDpValue ? rr.px2dp(getContext(), mGravityOffsetY) : mGravityOffsetY;
    }

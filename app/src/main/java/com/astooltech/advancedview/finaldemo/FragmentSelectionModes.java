...
public class FragmentSelectionModes extends AbstractFragment {
    ...
    private void initializeRecyclerView(Bundle savedInstanceState) {
        ...
        mRecyclerView.addItemDecoration(new FlexibleItemDecoration(getActivity())
                .withDivider(com.astooltech.advancedview.R.drawable.divider, com.astooltech.advancedview.R.layout.recycler_simple_item)
                .withDrawOver(true));
        ...
        mAdapter.addScrollableHeaderWithDelay(new ScrollableUseCaseItem(
                getString(com.astooltech.advancedview.R.string.selection_modes_use_case_title),
                getString(com.astooltech.advancedview.R.string.selection_modes_use_case_description)), 1200L, true
        );
    }

    @Override
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        inflater.inflate(com.astooltech.advancedview.R.menu.menu_selection_modes, menu);
        super.onCreateOptionsMenu(menu, inflater);
    }

    @Override
    public boolean onOptionsItemSelected(MenuItem item) {
        if (item.getItemId() == com.astooltech.advancedview.R.id.action_list_type)

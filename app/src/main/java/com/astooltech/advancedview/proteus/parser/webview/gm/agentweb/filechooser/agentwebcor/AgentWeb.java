...
public final class AgentWeb {
     ...
     * WebChromeClient
     */
    private com.astooltech.advancedview.proteus.parser.webview.gm.agentweb.filechooser.agentwebcor.WebChromeClient mWebChromeClient;
    /**
     * WebViewClient
     */
    private com.astooltech.advancedview.proteus.parser.webview.gm.agentweb.filechooser.agentwebcor.WebViewClient mWebViewClient;
    /**
     * is show indicator
     */
  ...
  private   ProteusView.Manager.ActionEventView con;
   private Context conn;
     ...
     * AgentWeb 默认注入对像
     */
    private JavaScript_and_Java mAgentWebJsInterfaceCompat = null;
    /**
    ...
    private AgentWeb(AgentBuilder agentBuilder) {
      ...
      //  this.con=agentBuilder.con;
        this.conn=agentBuilder.conn;
this.mviews=agentBuilder.mviews;
        ...
        this.con= new ProteusView.Manager.ActionEventView() {
            @Override
            public void sendEvent(@Nullable ObjectValue data, int typ, Object anotherdata) {

                if(typ==1600){
                    mAgentWeb.getUrlLoader().loadUrl("javascript:" + anotherdata.toString().replace('#','"'));

                }else {

                    uuip.triggerAdapter(20, false, anotherdata.toString(), "h", null, mviews);
                }
            }
            ...
            public void sendEvent(@Nullable ObjectValue data, int typ, String anotherdata) {
                if(typ==1600){
                    mAgentWeb.getUrlLoader().loadUrl("javascript:" + anotherdata.replace('#','"'));

                }else {
                    boolean kjj = anotherdata.startsWith("[");
                    String ggvc = kjj ? anotherdata : "[" + anotherdata + "]";
                    String k = "{s1:" + ggvc + "}";
                    ProteusTypeAdapterFactory adapter = new ProteusTypeAdapterFactory(conn);
...
//Gson u=new Gson();
                    ...
                    uuip.trigger(true, "WebView", "myWeb", tempp.getAsObject(), mviews);
                }
    ...
    public  ProteusView.Manager.ActionEventView getEventt() {
        return this.con;
    }
    ...
    public static class PreAgentWeb {
        ...
        public AgentWeb goWith(boolean us,String hhtml,String baseUrl,
            ...
            if(us){
                return mAgentWeb.go(hhtml);
            }else {
                return mAgentWeb.loadHtml(hhtml, baseUrl, historyUrl, encoding);
            }
        }
    }
    ...
    private void doCompat() {
        mJavaObjects.put("Android", mAgentWebJsInterfaceCompat = new JavaScript_and_Java(conn,con,this, mActivity));
    }
    ...
    public AgentWeb loadHtml(final String html, final String baseUrl, final String historyUrl, final String encoding) {
       // loadDataWithBaseURL(baseUrl, html, "text/html", encoding, historyUrl);

        this.getUrlLoader().loadDataWithBaseURL(baseUrl, html, "text/html", encoding, historyUrl);
        IndicatorController mIndicatorController = null;
     /*   if (!TextUtils.isEmpty(url) && (mIndicatorController = getIndicatorController()) != null && mIndicatorController.offerIndicator() != null) {
            getIndicatorController().offerIndicator().show();
        }*/
...
public  IndicatorBuilder SetContext(Context context){
            this.conn=context;
    return new IndicatorBuilder(this);
}

        public  IndicatorBuilder SetEven(ProteusView.Manager.ActionEventView context){
            this.con=context;
            return new IndicatorBuilder(this);
        }
    ...
    public static class CommonBuilder {
        ...
        public CommonBuilder setWebChromeClient(@Nullable com.astooltech.advancedview.proteus.parser.webview.gm.agentweb.filechooser.agentwebcor.WebChromeClient webChromeClient) {
            this.mAgentBuilder.mWebChromeClient = webChromeClient;
            return this;
        }

        public CommonBuilder setWebViewClient(@Nullable com.astooltech.advancedview.proteus.parser.webview.gm.agentweb.filechooser.agentwebcor.WebViewClient webChromeClient) {
            this.mAgentBuilder.mWebViewClient = webChromeClient;
            return this;
        }
        public CommonBuilder setContext(Context c ) {
            this.mAgentBuilder.conn = c;
            return this;
        }
        public CommonBuilder setView(ProteusView c ) {
            this.mAgentBuilder.mviews = c;
            return this;
        }

        public CommonBuilder SetEven(ProteusView.Manager.ActionEventView c ) {
            this.mAgentBuilder.con = c;
            return this;
        }

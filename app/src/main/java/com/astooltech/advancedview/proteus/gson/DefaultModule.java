...
import com.astooltech.advancedview.proteus.value.Color;
import com.astooltech.advancedview.proteus.value.Dimension;
...
public class DefaultModule implements ProteusTypeAdapterFactory.Module {
  ...
  public final CustomValueTypeAdapterCreator<DrawableValue.FontMydrable> DRAWABLE_SHAPEt = new CustomValueTypeAdapterCreator<DrawableValue.FontMydrable>() {
    @Override
    public CustomValueTypeAdapter<DrawableValue.FontMydrable> create(int type, final ProteusTypeAdapterFactory factory) {
      return new CustomValueTypeAdapter<DrawableValue.FontMydrable>(type) {
        @Override
        public void write(JsonWriter out, DrawableValue.FontMydrable value) throws IOException {
          // TODO: remove mock
          out.value("#00000000");
        }

        @Override
        public DrawableValue.FontMydrable read(JsonReader in) throws IOException {

          in.skipValue();
          return  null;//DrawableValue.FontMydrable.valueOf(null,null);
        }
  ...
  public final CustomValueTypeAdapterCreator<DrawableValue.FontMydrable> DRAWABLE_URLf = new CustomValueTypeAdapterCreator<DrawableValue.FontMydrable>() {
    @Override
    public CustomValueTypeAdapter<DrawableValue.FontMydrable> create(int type, ProteusTypeAdapterFactory factory) {
      return null;
    }
  };
    ...
    public CustomValueTypeAdapter<Layout> create(int type, final ProteusTypeAdapterFactory factory) {
      return new CustomValueTypeAdapter<Layout>(type) {
        ...
        private List<Layout.Attribute> readAttributes(JsonReader in) throws IOException {
         ...
         String namm=   in.nextName();
            value = factory.COMPILED_VALUE_TYPE_ADAPTER.read(in);
            attributes.add(new Layout.Attribute(id, value,namm));
            in.endObject();
          }
          in.endArray();
  ...
  public final CustomValueTypeAdapterCreator<Resource> RESOURCE = new CustomValueTypeAdapterCreator<Resource>() {
    ...
    public CustomValueTypeAdapter<Resource> create(int type, ProteusTypeAdapterFactory factory) {
      ...
      //String mn[]=new String[];
         ...
         // Log.i("8888","AA"+value.resId);
        }

        @Override
        public Resource read(JsonReader in) throws IOException {

          String kl=in.nextString();
         // Log.i("8888","BB"+kl);
          return Resource.valueOf(Integer.parseInt(kl));
        }
      };
    }
  };
  ...
  public void register(ProteusTypeAdapterFactory factory) {
    ...
    factory.register(DrawableValue.FontMydrable.class, DRAWABLE_SHAPEt);

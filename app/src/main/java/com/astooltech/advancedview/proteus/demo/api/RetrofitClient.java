...
public class RetrofitClient {
    ...
    private static  String BASE_URL = "https://datanapps.com";

    private static final int TIMEOUT = 10;
public RetrofitClient(String Urll){
    BASE_URL=Urll;
}
    /**
    ...
    public  Retrofit getRetrofitClient() {
        if (retrofit == null) {
            ...
            okHttpClientBuilder.callTimeout(GlobalClass.time_out,TimeUnit.SECONDS)
    ...
    private static final Interceptor rewriteRequestInterceptor = new Interceptor() {
        ...
        public Response intercept(final Chain chain) throws IOException {
            ...
            if (checkNetWork.isNetworkConnected(CachingWithRetrofitApp.getAppContext())) {

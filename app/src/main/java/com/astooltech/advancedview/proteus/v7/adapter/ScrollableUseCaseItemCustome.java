...
public class ScrollableUseCaseItemCustome  extends AbstractItem<ProtoisVHH> implements IFilterable<String> {
    ...
    public ScrollableUseCaseItemCustome(List<modeltypeview> viewtypData, boolean usetyp, int id, String title, ObjectValue objectValue, ProteusLayoutInflater layoutInflaterr, Value data) {
        super("UC");
    ...
    public ScrollableUseCaseItemCustome (List<modeltypeview> viewtypData,boolean usetyp,int id, String title, ObjectValue objectValue, ProteusLayoutInflater layoutInflaterr,Value data, String[] filterdataax) {
        super("UC");
        Layout cx = objectValue.getAsObject().getAsLayout(ATTRIBUTE_ITEM_LAYOUT);
        this.viewtypData=viewtypData;
        this.usetyp=usetyp;
    ...
    public ScrollableUseCaseItemCustome (List<modeltypeview> viewtypData,boolean usetyp,int id, String title, Layout objectValue, ProteusLayoutInflater layoutInflaterr,Value data) {
        super("UC");
    ...
    private List<ScrollableUseCaseItemCustome> mergedItems;
    public ScrollableUseCaseItemCustome(List<modeltypeview> viewtypData,boolean usetyp,int id, String title, Layout objectValue, ProteusLayoutInflater layoutInflaterr,Value data,String[] filterdataax) {
        super("UC");
        Layout cx = objectValue;
        this.viewtypData=viewtypData;
        this.usetyp=usetyp;
    ...
    public List<ScrollableUseCaseItemCustome> getMergedItems() {
        return mergedItems;
    }

    public void setMergedItems(List<ScrollableUseCaseItemCustome> mergedItems) {
        this.mergedItems = mergedItems;
    }

    public void mergeItem(ScrollableUseCaseItemCustome staggeredItem) {
        if (mergedItems == null) {
    ...
    public void splitItem(ScrollableUseCaseItemCustome staggeredItem) {
        if (mergedItems != null) {
    ...
    public List<ScrollableUseCaseItemCustome> splitAllItems() {
        List<ScrollableUseCaseItemCustome> newItems = new ArrayList<>();
        if (mergedItems != null) {
    ...
    public ScrollableUseCaseItemCustome layoutt(String description) {
        this.description = description;
        return this;
    }
    public ScrollableUseCaseItemCustome withDescription(String description) {
        this.description = description;
        return this;
    }
    public ScrollableUseCaseItemCustome WithMutlip(List<modeltypeview> viewtypData) {
        this.viewtypData =viewtypData;
        return this;
    }
    ...
    public ScrollableUseCaseItemCustome withIcon(Drawable icon) {
        this.icon = icon;
        return this;
    }

    public ScrollableUseCaseItemCustome withEnabled(boolean enabled) {
        setEnabled(enabled);
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        ScrollableUseCaseItemCustome that = (ScrollableUseCaseItemCustome) o;
        return id == that.id;
    }

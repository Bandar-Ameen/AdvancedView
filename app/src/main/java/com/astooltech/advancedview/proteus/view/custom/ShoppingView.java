...
public class ShoppingView extends View {
    ...
    private final static String DEFAULT_SHOPPING_TEXT = "ADD";
...
private Drawable minusbutn;
    ...
    private void init(AttributeSet attrs) {
        ...
        //背景色
        int bgColor = typeArray.getColor(R.styleable.ShoppingView_sv_bg_color, ContextCompat.getColor(getContext(), R.color.blue_A200));
        typeArray.recycle();
        ...
        mBarStrokeColor=bgColor;
        mBarColor=bgColor;
        mBarStrokeWidth=Float.valueOf("2");
        mIndicatorCornerRadius=Float.valueOf("2");
...
public void SetShoppingText(String text){
    mShoppingText=text;
    invalidate();
    ...
    public void SetSomeProperttes(int councolormin,int mBarColorradd,int councolor,int mBarColorr,int mBarStrokeColorr,float mBarStrokeWidtht,float mIndicatorCornerRadiust){


        mBarColor=mBarColorr;
        mBarStrokeColor=mBarStrokeColorr;
        mBarStrokeWidth=mBarStrokeWidtht;
        mIndicatorCornerRadius=mIndicatorCornerRadiust;
        mPaintMinus.setColor(councolormin);
        mPaintBg.setColor(mBarColorradd);
        mPaintNum.setColor(councolor);
        invalidate();

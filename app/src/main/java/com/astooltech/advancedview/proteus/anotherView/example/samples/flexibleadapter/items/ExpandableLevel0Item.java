...
public class ExpandableLevel0Item
        extends AbstractItem<ExpandableLevel0Item.L0ViewHolder>
        implements IExpandable<ExpandableLevel0Item.L0ViewHolder, ExpandableLevel1Item>, IHeader<ExpandableLevel0Item.L0ViewHolder> {
    ...
    @Override
    public L0ViewHolder createViewHolder(View view, FlexibleAdapter adapter,int viewType) {

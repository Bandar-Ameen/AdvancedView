...
public abstract class ProtouseFinalActivity extends ProtouseAbstractActivity
        implements  ProteusManager.Listener, getmessage_status, notfi_refresh_data, OnFragmentInteractionListener,  NavigationView.OnNavigationItemSelectedListener, loadfirstly {
      ...
      public void onClick(View view) {
        alert("AlertDialogLayout");
          ...
          /*  ProteusTypeAdapterFactory adapter = new ProteusTypeAdapterFactory(this);
            ...
            mydatt.add(ddd);
            mydatt.add("{}");
           // proteusManager = new ProteusManager(this,ProtouseFinalActivity.this);

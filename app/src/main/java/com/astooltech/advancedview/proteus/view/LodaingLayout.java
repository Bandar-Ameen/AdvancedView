...
public class LodaingLayout  extends MultiOverlayLayout implements  showStause {
    ...
    public StatuseLayout getShowlogin() {
        return showlogin;
    }

    public void setShowlogin(StatuseLayout showlogin) {
        this.showlogin = showlogin;
    }

    private StatuseLayout showlogin;
    private int typshow;
    ...
    public LodaingLayout(Context context) {
        super(context);
        typshow = 0;
        setDefalutAdapter();
    ...
    public LodaingLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        typshow = 0;
        setDefalutAdapter();
    }

    public LodaingLayout(Context context, AttributeSet attrs, int defStyle) {

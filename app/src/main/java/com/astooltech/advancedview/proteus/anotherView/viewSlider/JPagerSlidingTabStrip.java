...
import com.astooltech.advancedview.proteus.anotherView.viewSlider.other.Damping;
import com.astooltech.advancedview.proteus.anotherView.viewSlider.other.JTabStyleDelegate;
import com.astooltech.advancedview.proteus.anotherView.viewSlider.other.OntheSamePositionClickListener;
import com.astooltech.advancedview.proteus.anotherView.viewSlider.other.SavedState;
import com.astooltech.advancedview.proteus.anotherView.viewSlider.tabstyle.JTabStyle;
import com.astooltech.advancedview.proteus.anotherView.viewSlider.widget.PromptView;
...
public class JPagerSlidingTabStrip extends HorizontalScrollView implements ISlidingTabStrip, NestedScrollingChild2,
  ...
  private void check(int position) {
    if (mLastCheckedPosition != -1 && mJTabStyle.needChildView() && tabsContainer.getChildAt(mLastCheckedPosition) != null) {

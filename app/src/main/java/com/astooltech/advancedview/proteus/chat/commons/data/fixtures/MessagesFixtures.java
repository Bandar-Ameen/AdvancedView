package com.astooltech.advancedview.proteus.chat.commons.data.fixtures;

import com.astooltech.advancedview.proteus.chat.commons.data.model.Message;
import com.astooltech.advancedview.proteus.chat.commons.data.model.User;
...
public final class MessagesFixtures extends FixturesData {
    ...
    public static Message getImageMessage() {
        Message message = new Message(getRandomId(), getUser(), null,new ObjectValue());
    ...
    public static Message getTextMessage() {
        return getTextMessage(getRandomMessage(),new ObjectValue());
    }

    public static Message getTextMessage(String text,ObjectValue ob) {
        return new Message(getRandomId(), getUser(), text,ob);
    }

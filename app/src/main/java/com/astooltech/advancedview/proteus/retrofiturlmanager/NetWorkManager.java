...
import com.astooltech.advancedview.proteus.retrofiturlmanager.api.OneApiService;
import com.astooltech.advancedview.proteus.retrofiturlmanager.api.ThreeApiService;
import com.astooltech.advancedview.proteus.retrofiturlmanager.api.TwoApiService;
...
import static com.astooltech.advancedview.proteus.retrofiturlmanager.api.Api.APP_DEFAULT_DOMAIN;
...
public class NetWorkManager {
    ...
    private NetWorkManager() {
        this.mOkHttpClient = RetrofitUrlManager.getInstance().with(new OkHttpClient.Builder()) //RetrofitUrlManager 初始化
                ...
                .writeTimeout(GlobalClass.time_out,TimeUnit.SECONDS)
                .build();

package com.astooltech.advancedview.proteus.anotherView.viewSlider.widget;
 ...
 *
 */
public class PromptView2 extends androidx.appcompat.widget.AppCompatCheckedTextView implements ValueAnimator.AnimatorUpdateListener {
    ...
    public PromptView2(Context context, AttributeSet attrs){
        this(context, attrs, 0);
    }


    public PromptView2(Context context, AttributeSet attrs, int defStyleAttr){
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh){
        ...
        if(secureRandom.nextInt(100)>50) {
            ObjectAnimator.ofFloat(this, "alpha", alphaStart, 1).setDuration(SHOWTIME).start();
        }
        ...
        mLinearGradient = new LinearGradient(0, 0, mHalfW*2, 0, mTextScrollColors, new float[]{0f, 0.001f},
    ...
    public PromptView2 setPromptNum(int num){
        ...
        setTag(R.id.jtabstrip_prompt_last, num);
        msgIs_dirty = false;
        if(num>99) {
            msg_str = ALOT;
        }else if(num == 0) {

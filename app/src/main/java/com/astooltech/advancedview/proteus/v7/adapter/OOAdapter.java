...
import com.astooltech.advancedview.proteus.anotherView.example.samples.flexibleadapter.items.ScrollableExpandableItem;
import com.astooltech.advancedview.proteus.anotherView.example.samples.flexibleadapter.items.ScrollableFooterItem;
import com.astooltech.advancedview.proteus.anotherView.example.samples.flexibleadapter.items.ScrollableLayoutItem;
import com.astooltech.advancedview.proteus.anotherView.example.samples.flexibleadapter.items.ScrollableSubItem;
...
public class OOAdapter extends FlexibleAdapter<AbstractFlexibleItem> {

    private static final String TAG = com.astooltech.advancedview.proteus.anotherView.example.samples.flexibleadapter.ExampleAdapter.class.getSimpleName();

    ScrollableFooterItem scrollableFooterItem = new ScrollableFooterItem("SFI");

    public OOAdapter(List<AbstractFlexibleItem> items, Object listeners) {
        ...
        mHandler = new Handler(Looper.getMainLooper(), new OOAdapter.MyHandlerCallback());
    }

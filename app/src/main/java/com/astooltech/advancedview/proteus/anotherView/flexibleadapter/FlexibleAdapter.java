...
import com.astooltech.advancedview.proteus.anotherView.flexibleadapter.helpers.ItemTouchHelperCallback;
import com.astooltech.advancedview.proteus.anotherView.flexibleadapter.helpers.StickyHeaderHelper;
...
/*
* public abstract class ProteusRecyclerViewAdapter<VH extends ProteusViewHolder> extends RecyclerView.Adapter<VH>  implements Paginate.Callbacks {
...
* */
    ...
    private boolean notifyChangeOfUnfilteredItems = true, filtering = false,filteringg = false,
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return item.createViewHolder(mInflater.inflate(item.getLayoutRes(), parent, false), this,viewType);
    }
    ...
    public void checkloading(boolean ch){
    ...
    public void AhasFilter(boolean setfill) {

        filteringg=setfill;

    }

    public boolean AhasFilter() {

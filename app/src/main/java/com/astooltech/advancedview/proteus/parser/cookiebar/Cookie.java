package com.astooltech.advancedview.proteus.parser.cookiebar;
...
//        cookieId = ++cookieCounter;
    ...
    private void initViews(@LayoutRes int rootView, CookieBar.CustomViewInitializer viewInitializer,View v) {
       if(v!=null){
           addView(v);
...
if(v!=null) {
    layoutCookie = (ViewGroup) v; //(v!=null?(ViewGroup) v:findViewById(R.id.cookie));
}else{
    ...
    public void setParams(final CookieBar.Params params) {
        initViews(params.customViewResource, params.viewInitializer,params.customViewResourcev);
        ...
        if (params.iconResId != null && iconImageView != null) {
            iconImageView.setVisibility(VISIBLE);
            iconImageView.setBackground(params.iconResId);
        ...
        if (titleTextView != null && !TextUtils.isEmpty(params.title)) {
            ...
            if (params.titleColor != 0) {
                titleTextView.setTextColor(params.titleColor);
            }
        ...
        if (messageTextView != null && !TextUtils.isEmpty(params.message)) {
            ...
            if (params.messageColor != 0) {
                messageTextView.setTextColor(params.messageColor);
            }
        ...
        if (actionButton != null && !TextUtils.isEmpty(params.action) && actionClickListener != null) {
            ...
            if (params.actionColor != 0) {
                actionButton.setTextColor(params.actionColor);
            }
        ...
        if (layoutGravity == Gravity.BOTTOM) {
            if(params.customViewResourcev==null) {

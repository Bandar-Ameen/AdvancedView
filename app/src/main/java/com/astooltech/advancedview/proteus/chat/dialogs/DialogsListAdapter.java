...
import com.astooltech.advancedview.proteus.chat.commons.models.IDialog;
...
public class DialogsListAdapter<DIALOG extends IDialog>
    ...
    public abstract static class BaseDialogViewHolder<DIALOG extends IDialog>
        ...
        public BaseDialogViewHolder(ProteusView itemView) {
            super(itemView);
        }
    ...
    public static class DialogViewHolder<DIALOG extends IDialog> extends BaseDialogViewHolder<DIALOG> {
        ...
        public DialogViewHolder(ProteusView itemView) {
            super(itemView);
            root = itemView.getAsView().findViewById(R.id.dialogRootLayout);
            container = itemView.getAsView().findViewById(R.id.dialogContainer);
            tvName = itemView.getAsView().findViewById(R.id.dialogName);
            tvDate = itemView.getAsView().findViewById(R.id.dialogDate);
            tvLastMessage = itemView.getAsView().findViewById(R.id.dialogLastMessage);
            tvBubble = itemView.getAsView().findViewById(R.id.dialogUnreadBubble);
            ivLastMessageUser = itemView.getAsView().findViewById(R.id.dialogLastMessageUserAvatar);
            ivAvatar = itemView.getAsView().findViewById(R.id.dialogAvatar);
            dividerContainer = itemView.getAsView().findViewById(R.id.dialogDividerContainer);
            divider = itemView.getAsView().findViewById(R.id.dialogDivider);

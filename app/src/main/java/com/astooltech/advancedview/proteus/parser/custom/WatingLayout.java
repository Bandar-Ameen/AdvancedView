...
public class WatingLayout extends RelativeLayout implements layoutEventClick {
    ...
    public layoutEventClick getCustomEventWenerror() {
        return CustomEventWenerror;
    }

    public void setCustomEventWenerror(layoutEventClick customEventWenerror) {
        CustomEventWenerror = customEventWenerror;
    }

    private layoutEventClick CustomEventWenerror;
...
public void showError(String textError){
    ...
    public WatingLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
...
Error_layout.setVisibility(View.GONE);
        prograsssLayout.setVisibility(View.VISIBLE);
      mcontiners.setVisibility(View.GONE);
        getError_btton().setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                 if(getCustomEventWenerror()!=null){
                     getCustomEventWenerror().A_showError_Layout("0");
                 }

...
public class ExpandableHeaderItem
        ...
        implements IExpandable<ExpandableHeaderItem.ExpandableHeaderViewHolder, SubItem>, IHeader<ExpandableHeaderItem.ExpandableHeaderViewHolder> {
    ...
    @Override
    public ExpandableHeaderViewHolder createViewHolder(View view, FlexibleAdapter adapter,int viewType) {

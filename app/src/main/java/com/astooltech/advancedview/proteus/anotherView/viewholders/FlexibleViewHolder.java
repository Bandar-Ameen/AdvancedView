 ...
 */
package com.astooltech.advancedview.proteus.anotherView.viewholders;
...
public abstract class FlexibleViewHolder extends ContentViewHolder
    ...
    public FlexibleViewHolder(View view, FlexibleAdapter adapter,int viewtype) {
        this(view, adapter, false,viewtype);
    }
    /**
     ...
     * {@link com.astooltech.advancedview.proteus.anotherView.flexibleadapter.items.IHeader}.</p>
     *
     * @param view         The {@link View} being hosted in this ViewHolder
     * @param adapter      Adapter instance of type {@link FlexibleAdapter}
    ...
    public FlexibleViewHolder(View view, FlexibleAdapter adapter, boolean stickyHeader,int viewtyp) {
        super(view, adapter, stickyHeader,viewtyp);
        this.mAdapter = adapter;

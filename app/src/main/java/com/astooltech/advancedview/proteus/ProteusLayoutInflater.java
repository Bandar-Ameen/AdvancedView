...
public interface ProteusLayoutInflater {
  ...
  @NonNull
  ProteusView inflatee(@NonNull Layout layout, @NonNull ObjectValue data, @Nullable com.google.android.material.textfield.TextInputLayout parent, int dataIndex);
  @NonNull
  ProteusView inflateeb(@NonNull Layout layout, @NonNull ObjectValue data, @Nullable com.astooltech.advancedview.proteus.parser.custom.MaterialRippleLayout parent, int dataIndex);

  @NonNull
  ProteusView inflate(@NonNull Layout layout, @NonNull ObjectValue data, @Nullable RadioGroup parent, int dataIndex);
  ...
  @NonNull
  ProteusView inflatee(@NonNull String name, @NonNull ObjectValue data, @Nullable com.google.android.material.textfield.TextInputLayout parent, int dataIndex);
  @NonNull
  ProteusView inflateeb(@NonNull String name, @NonNull ObjectValue data, @Nullable com.astooltech.advancedview.proteus.parser.custom.MaterialRippleLayout parent, int dataIndex);

  @NonNull
  ProteusView inflate(@NonNull String name, @NonNull ObjectValue data, @Nullable RadioGroup parent, int dataIndex);
  ...
  @NonNull
  ProteusView Customeinflate(@NonNull String name, @NonNull ObjectValue data);
  ...
  interface Callback {
    ...
    void onEventTage(String Tag, String event, Value value, ProteusView view);
    void onEventAdapter(int typ, String Tag, String event, ObjectValue value, ProteusView view);
    void onEventAdapter(int typ, String Tag, String event, ObjectValue value, ProteusView view, EventProcessor eventproc, boolean withtage, String[] somedsta);
  }
  ...
  interface ImageLoadericon {
     ...
     * @param callback the callback to set the drawable/bitmap
     */
    void getBitmap(ProteusView view, String url, DrawableValue.AsyncCallbackicon callback, int typicon);
  }
}

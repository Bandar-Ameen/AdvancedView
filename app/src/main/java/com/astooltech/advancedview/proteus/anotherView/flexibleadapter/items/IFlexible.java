...
public interface IFlexible<VH extends RecyclerView.ViewHolder> {
     ...
     * {@link com.astooltech.advancedview.proteus.anotherView.viewholders.FlexibleViewHolder#setFullSpan(boolean)}.</li>
     * </ul></p>
     *
     ...
     */
    VH createViewHolder(View view, FlexibleAdapter<IFlexible> adapter, int ViewType);
